...
AVAILABLE_VLMS = {
    ...
    "meta/llama-3.2-11b": "https://ai.api.nvidia.com/v1/gr/meta/llama-3.2-11b-vision-instruct",
    "meta/llama-3.2-90b": "https://ai.api.nvidia.com/v1/gr/meta/llama-3.2-90b-vision-instruct",
    ...
    "nvidia/VILA": "https://ai.api.nvidia.com/v1/vlm/nvidia/vila",
    "None": None,
}
SUGGESTED_LLMS = [
...
def extract_text(vlm, llm, ocd, structured_fields, image_input):
    ...
    pipeline = TextExtraction(api_key_g, AVAILABLE_VLMS[vlm], llm, ocd)
...
def main(port):
    with gr.Blocks() as demo:
        gr.HTML(
            '<h1 style="color: #6aa84f; font-size: 250%;">Vision NIM microservices for Structured Text Extraction</h1>'
        )
        with gr.Row():
